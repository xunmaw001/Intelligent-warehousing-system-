		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑商品出库</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>商品出库管理</span></li>
								<li class="breadcrumb-item active"><span>编辑商品出库</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品出库信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>售价</label>
										<input id="shoujia" name="shoujia" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>总金额</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shangpinchuku/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shangpinchuku/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shangpinchuku/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculation(){
			...
			if($("#shoujia").val() != null && $("#shoujia").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#shoujia").val());
					flag++;
				}else{
					x = x * parseFloat($("#shoujia").val());
					flag++;
				}
			}
			if(flag < 2){
		...
		function calculationSE(colName){
			//单列求和接口
			http("shangpinchuku"+colName,"GET",{
