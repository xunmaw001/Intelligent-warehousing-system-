						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>分类</label>
										<input id="fenlei" name="fenlei" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>规格</label>
										<input id="guige" name="guige" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>进价</label>
										<input id="jinjia" name="jinjia" class="form-control" placeholder="进价">
									</div>
									<div class="form-group col-md-6">
										<label>售价</label>
	...
	<script>
		...
		var crossRuleForm = {};
			...
			function shangpinmingchengSelect2(){
				http("option/huowucaigou/shangpinmingcheng","GET",{
			...
			function shangpinmingchengSelect2Change(){
				...
				http("follow/huowucaigou/shangpinmingcheng","GET",{
					tableName: "huowucaigou",
					columnName: "shangpinmingcheng",
					columnValue: colVal
				},(res)=>{
					if(res.code == 0){
						if(res.data != null && res.data.fenlei != null){
							$("#fenlei").val(res.data.fenlei);
						}
						if(res.data != null && res.data.guige != null){
