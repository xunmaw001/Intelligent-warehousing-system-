...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jinjia')">进价<i id="jinjiaIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function init() {
			// 满足条件渲染提醒接口
			http("remind/shangpinxinxi/shuliang/1","GET",{
									remindend:50
			},(res)=>{
		...
		function setDataRow(item,number){
			...
			var jinjiaCell  = document.createElement('td');

						 jinjiaCell.innerHTML = item.jinjia;


			row.appendChild(jinjiaCell);
			...
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"shangpinruku\")");
			...
			crossBtn2.setAttribute("onclick","crossTable(" + item.id + ",\"shangpinchuku\")");
