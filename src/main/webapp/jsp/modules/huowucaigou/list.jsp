...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">货物采购管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>货物采购管理</span></li>
								<li class="breadcrumb-item active"><span>货物采购列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">货物采购列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									...
									<input type="text" id="gongyingshangzhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										员工姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('caigoujine')">采购金额<i id="caigoujineIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('caigouriqi')">采购日期<i id="caigouriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#gongyingshangzhanghaoSearch').val() != null && $('#gongyingshangzhanghaoSearch').val() != ''){
				searchForm.gongyingshangzhanghao ="%" +  $('#gongyingshangzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("huowucaigou/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				shangpinmingcheng : searchForm.shangpinmingcheng,	
				gongyingshangzhanghao : searchForm.gongyingshangzhanghao,	
		...
		function setDataRow(item,number){
			...
			var caigoujineCell  = document.createElement('td');

						 caigoujineCell.innerHTML = item.caigoujine;


			row.appendChild(caigoujineCell);
			...
			var caigouriqiCell  = document.createElement('td');

						  caigouriqiCell.innerHTML = item.caigouriqi;


			row.appendChild(caigouriqiCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("huowucaigou/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("huowucaigou/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("huowucaigou/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"huowucaigou");
