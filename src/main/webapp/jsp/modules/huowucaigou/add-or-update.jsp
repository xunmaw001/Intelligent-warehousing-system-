		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑货物采购</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑货物采购</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">货物采购信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>单价</label>
										<input id="danjia" name="danjia" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>数量</label>
									...
									<div class="form-group col-md-6">
										<label>采购金额</label>
										<input id="caigoujine" name="caigoujine" class="form-control" placeholder="采购金额">
									</div>
									<div class="form-group col-md-6">
										<label>供应商账号</label>
									...
									<div class="form-group col-md-6">
										<label>采购日期</label>
										<div id="caigouriqiDate" class="input-append date form_datetime">
											<input id="caigouriqi-input" name="caigouriqi" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "huowucaigou/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("huowucaigou/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.caigoujine != null && res.data.caigoujine != ''){

					$("#caigoujine").val(res.data.caigoujine);
					}
					...
					if(res.data != null && res.data != '' && res.data.caigouriqi != null && res.data.caigouriqi != ''){

					$("#caigouriqi-input").val(res.data.caigouriqi);
					$('#caigouriqiFileName').val(res.data.caigouriqi)
					}
