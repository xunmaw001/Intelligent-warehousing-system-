...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">在线沟通管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>在线沟通列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">在线沟通列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>沟通内容</th>
											<th onclick="sort('goutongshijian')">沟通时间<i id="goutongshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var goutongneirongCell  = document.createElement('td');

						  if(item.goutongneirong != null && item.goutongneirong != "" && item.goutongneirong.length >= 11){
			  	goutongneirongCell.innerHTML = item.goutongneirong.substring(0, 10) + "..."; 
			  }else{
			  	goutongneirongCell.innerHTML = item.goutongneirong;
			  }


			row.appendChild(goutongneirongCell);
			var goutongshijianCell  = document.createElement('td');

						  goutongshijianCell.innerHTML = item.goutongshijian;


			row.appendChild(goutongshijianCell);
		...
		function sh(){
			...
			httpJson("zaixiangoutong/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zaixiangoutong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zaixiangoutong");
