...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									...
									<input type="text" id="lianxirenSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('lianxidizhi')">联系地址<i id="lianxidizhiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var lianxidizhiCell  = document.createElement('td');

						 lianxidizhiCell.innerHTML = item.lianxidizhi;


			row.appendChild(lianxidizhiCell);
            ...
            crossBtn1.innerHTML = "沟通"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"zaixiangoutong\")");
			if(crossBtnControl('沟通') == true){
