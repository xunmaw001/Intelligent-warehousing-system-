...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>联系地址</label>
										<input id="lianxidizhi" name="lianxidizhi" class="form-control" placeholder="联系地址">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#lianxidizhi").val(ruleForm.lianxidizhi);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.lianxidizhi != null && res.data.lianxidizhi != ''){

					$("#lianxidizhi").val(res.data.lianxidizhi);
					}
				}
			});  
            }
